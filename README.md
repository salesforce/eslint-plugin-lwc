...
| [lwc/no-unguarded-risky-node-api-in-ssrable-components](./docs/rules/no-unguarded-risky-node-api-in-ssrable-components.md) | disallow unguarded risky Node API calls in SSR-able components |         |
