...
| [lwc/no-risky-node-api-in-ssrable-components](./docs/rules/no-risky-node-api-in-ssrable-components.md) | disallow risky Node API calls in SSR-able components      |         |
