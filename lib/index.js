...
const rules = {
    ...
    'no-document-during-ssr': require('./rules/no-document-during-ssr'),
    'no-querying-slots-during-ssr': require('./rules/no-querying-slots-during-ssr'),
    'no-restricted-browser-globals-during-ssr': require('./rules/no-restricted-browser-globals-during-ssr'),
    'no-this-template-during-ssr': require('./rules/no-this-template-during-ssr'),
    'no-window-during-ssr': require('./rules/no-window-during-ssr'),
};
